...
module.exports = {
	...
	exclude: ['/api/*', '/get_discount/*', '/get_discount', '/rbx', '/wb/*', '/wb', '/activate', '/activate/*', '/payment', '/payment/*'],
		...
		policies: [
			{
				...
				disallow: ['/payment/verification', '/wb', '/digi', '/activate', '/get_discount', '/rbx', '/playstation', '/playstation_plus', '/spotify', '/playstation_account', '/adobe_creative_cloud', '/discord'
					...
					'/kak_vkluchit_2fa_na_akaunte_psn']
			},
		],
