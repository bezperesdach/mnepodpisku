    ...
    <div className="flex flex-col w-full max-w-[1240px] mx-auto mt-8 sm:mt-10 px-2 sm:px-4 mb-8">
      ...
      <div className="mt-10">
        ...
        <p className="text-lg font-medium mt-4">
          ...
          Активацию можно произвести на личный аккаунт без активной подписки (со сменой на регион индия), либо на новый аккаунт.
          <br />
          <br />
        ...
        <HeroChoose
          ...
          thirdText="Получите Spotify на ваш аккаунт"
        />
      </div>
      ...
      <Faq>
        ...
        <Question title="Как скачать Spotify на iPhone?">
          <p>
            Для того, чтобы скачать Spotify на iPhone необходимо сменить регион AppStore на индийский (или любой другой, где
