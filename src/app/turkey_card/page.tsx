    ...
    <div className="flex flex-col w-full max-w-[1240px] mx-auto mt-8 sm:mt-10 px-2 sm:px-4 mb-8">
      ...
      <Faq>
        ...
        <Question title="Можно ли вернуть средства?">
          <p>
            В случае если вы не сможете или передумаете использовать одноразовую турецкую карту, вы можете запросить осуществление
            возврата средств
            <br />
            <br />
            Мы проверим выданную вам карту на наличие списаний средств и, если по карте не было успешных операций и срок выдачи карты не
            более 7 дней, вернем вам сумму в соответствии с нашей офертой.
          </p>
        </Question>
        <Question title="Что делать если я не нашел нужный мне сервис?">
          <p>
            Если вы в списке доступных сервис не смогли найти нужный вам сервис, вы можете выбрать опцию "Другое", но в таком случае мы
            не гарантируем возможность того что вы сможете оплатить нашей картой нужные вам услуги{" "}
          </p>
        </Question>
      </Faq>
