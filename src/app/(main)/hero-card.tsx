...
const Banners = [
  ...
  // },
  {
    ...
    image: PlayStation_Style[18].image,
    alt: "Playstation пополнение банер",
    titleClass: PlayStation_Style[18].titleClass,
    titleStyle: PlayStation_Style[18].titleStyle,
    descriptionClass: PlayStation_Style[18].descriptionClass,
    descriptionStyle: PlayStation_Style[18].descriptionStyle,
    callToActionClass: PlayStation_Style[18].callToActionClass,
    href: "playstation",
  },
  {
