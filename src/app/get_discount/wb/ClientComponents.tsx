  ...
  return (
    <>
      ...
      <p className="text-sm mt-2">
        * - бонусные лиры закрепляются за контактом при обращении, если ты получил бонусные лиры на один номер, а активируешь с другого,
        мы не сможем активировать твои бонусы
      </p>
    </>
  );
}
