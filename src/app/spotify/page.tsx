    ...
    <div className="flex flex-col w-full max-w-[1240px] mx-auto mt-8 sm:mt-10 px-2 sm:px-4 mb-8">
      ...
      <div className="mt-10">
        ...
        <p className="text-lg font-medium mt-4">
          ...
          Активацию можно произвести на личный аккаунт без активной подписки (со сменой на турецкий регион), либо на новый аккаунт.
          <br />
          <br />
      ...
      <Faq>
        ...
        <Question title="Нужен ли турецкий аккаунт Spotify?">
          <p>
